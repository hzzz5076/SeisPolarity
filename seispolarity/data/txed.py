...
from .base import WaveformBenchmarkDataset, logger


class TXED(WaveformBenchmarkDataset):
    """
    TXED dataset implementation for SeisPolarity.
    Original dataset from Chen et al.

    SeisPolarity uses the standard train/dev/test split.
    """
    ...
    def _download_dataset(self, writer, basepath=None, **kwargs):
        ...
        logger.warning(
            "Converting TEXD files to SeisPolarity format. This might take a while."
        )
